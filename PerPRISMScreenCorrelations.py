...
# prism_public_full_eff_AUCsig = prism_public_full[prism_public_full['AUC_sig'] < prism_public_full['AUC_sig'].median()]
# mts021_full_eff_AUCsig = mts021_full[mts021_full['AUC_sig'] < mts021_full['AUC_sig'].median()]
# mts022_full_eff_AUCsig = mts022_full[mts022_full['AUC_sig'] < mts022_full['AUC_sig'].median()]
# mts023_full_eff_AUCsig = mts023_full[mts023_full['AUC_sig'] < mts023_full['AUC_sig'].median()]
# mts024_full_eff_AUCsig = mts024_full[mts024_full['AUC_sig'] < mts024_full['AUC_sig'].median()]
# mts025_full_eff_AUCsig = mts025_full[mts025_full['AUC_sig'] < mts025_full['AUC_sig'].median()]
# mts026_full_eff_AUCsig = mts026_full[mts026_full['AUC_sig'] < mts026_full['AUC_sig'].median()]
# prism_public_trunc_eff_AUCsig = prism_public_trunc[prism_public_trunc['AUC_sig'] < prism_public_trunc['AUC_sig'].median()]
# mts021_trunc_eff_AUCsig = mts021_trunc[mts021_trunc['AUC_sig'] < mts021_trunc['AUC_sig'].median()]
# mts022_trunc_eff_AUCsig = mts022_trunc[mts022_trunc['AUC_sig'] < mts022_trunc['AUC_sig'].median()]
# mts023_trunc_eff_AUCsig = mts023_trunc[mts023_trunc['AUC_sig'] < mts023_trunc['AUC_sig'].median()]
# mts024_trunc_eff_AUCsig = mts024_trunc[mts024_trunc['AUC_sig'] < mts024_trunc['AUC_sig'].median()]
# mts025_trunc_eff_AUCsig = mts025_trunc[mts025_trunc['AUC_sig'] < mts025_trunc['AUC_sig'].median()]
# mts026_trunc_eff_AUCsig = mts026_trunc[mts026_trunc['AUC_sig'] < mts026_trunc['AUC_sig'].median()]

# By AUC_trapz
# prism_public_full_eff_AUCtrapz = prism_public_full[prism_public_full['AUC_trapz'] < prism_public_full['AUC_trapz'].median()]
# mts021_full_eff_AUCtrapz = mts021_full[mts021_full['AUC_trapz'] < mts021_full['AUC_trapz'].median()]
# mts022_full_eff_AUCtrapz = mts022_full[mts022_full['AUC_trapz'] < mts022_full['AUC_trapz'].median()]
# mts023_full_eff_AUCtrapz = mts023_full[mts023_full['AUC_trapz'] < mts023_full['AUC_trapz'].median()]
# mts024_full_eff_AUCtrapz = mts024_full[mts024_full['AUC_trapz'] < mts024_full['AUC_trapz'].median()]
# mts025_full_eff_AUCtrapz = mts025_full[mts025_full['AUC_trapz'] < mts025_full['AUC_trapz'].median()]
# mts026_full_eff_AUCtrapz = mts026_full[mts026_full['AUC_trapz'] < mts026_full['AUC_trapz'].median()]
# prism_public_trunc_eff_AUCtrapz = prism_public_trunc[prism_public_trunc['AUC_trapz'] < prism_public_trunc['AUC_trapz'].median()]
# mts021_trunc_eff_AUCtrapz = mts021_trunc[mts021_trunc['AUC_trapz'] < mts021_trunc['AUC_trapz'].median()]
# mts022_trunc_eff_AUCtrapz = mts022_trunc[mts022_trunc['AUC_trapz'] < mts022_trunc['AUC_trapz'].median()]
# mts023_trunc_eff_AUCtrapz = mts023_trunc[mts023_trunc['AUC_trapz'] < mts023_trunc['AUC_trapz'].median()]
# mts024_trunc_eff_AUCtrapz = mts024_trunc[mts024_trunc['AUC_trapz'] < mts024_trunc['AUC_trapz'].median()]
# mts025_trunc_eff_AUCtrapz = mts025_trunc[mts025_trunc['AUC_trapz'] < mts025_trunc['AUC_trapz'].median()]
# mts026_trunc_eff_AUCtrapz = mts026_trunc[mts026_trunc['AUC_trapz'] < mts026_trunc['AUC_trapz'].median()]

# By AUC_sig_norm
# prism_public_full_eff_AUCsignorm = prism_public_full[prism_public_full['AUC_sig_norm'] < prism_public_full['AUC_sig_norm'].median()]
# mts021_full_eff_AUCsignorm = mts021_full[mts021_full['AUC_sig_norm'] < mts021_full['AUC_sig_norm'].median()]
# mts022_full_eff_AUCsignorm = mts022_full[mts022_full['AUC_sig_norm'] < mts022_full['AUC_sig_norm'].median()]
# mts023_full_eff_AUCsignorm = mts023_full[mts023_full['AUC_sig_norm'] < mts023_full['AUC_sig_norm'].median()]
# mts024_full_eff_AUCsignorm = mts024_full[mts024_full['AUC_sig_norm'] < mts024_full['AUC_sig_norm'].median()]
# mts025_full_eff_AUCsignorm = mts025_full[mts025_full['AUC_sig_norm'] < mts025_full['AUC_sig_norm'].median()]
# mts026_full_eff_AUCsignorm = mts026_full[mts026_full['AUC_sig_norm'] < mts026_full['AUC_sig_norm'].median()]
# prism_public_trunc_eff_AUCsignorm = prism_public_trunc[prism_public_trunc['AUC_sig_norm'] < prism_public_trunc['AUC_sig_norm'].median()]
# mts021_full_eff_AUCsignorm = mts021_trunc[mts021_trunc['AUC_sig_norm'] < mts021_trunc['AUC_sig_norm'].median()]
# mts022_full_eff_AUCsignorm = mts022_trunc[mts022_trunc['AUC_sig_norm'] < mts022_trunc['AUC_sig_norm'].median()]
# mts023_full_eff_AUCsignorm = mts023_trunc[mts023_trunc['AUC_sig_norm'] < mts023_trunc['AUC_sig_norm'].median()]
# mts024_full_eff_AUCsignorm = mts024_trunc[mts024_trunc['AUC_sig_norm'] < mts024_trunc['AUC_sig_norm'].median()]
# mts025_full_eff_AUCsignorm = mts025_trunc[mts025_trunc['AUC_sig_norm'] < mts025_trunc['AUC_sig_norm'].median()]
# mts026_full_eff_AUCsignorm = mts026_trunc[mts026_trunc['AUC_sig_norm'] < mts026_trunc['AUC_sig_norm'].median()]

# # By IC50
# prism_public_full_eff_IC50 = prism_public_full[prism_public_full['log_IC50'] < prism_public_full['log_IC50'].median()]
# mts021_full_eff_IC50 = mts021_full[mts021_full['log_IC50'] < mts021_full['log_IC50'].median()]
# mts022_full_eff_IC50 = mts022_full[mts022_full['log_IC50'] < mts022_full['log_IC50'].median()]
# mts023_full_eff_IC50 = mts023_full[mts023_full['log_IC50'] < mts023_full['log_IC50'].median()]
# mts024_full_eff_IC50 = mts024_full[mts024_full['log_IC50'] < mts024_full['log_IC50'].median()]
# mts025_full_eff_IC50 = mts025_full[mts025_full['log_IC50'] < mts025_full['log_IC50'].median()]
# mts026_full_eff_IC50 = mts026_full[mts026_full['log_IC50'] < mts026_full['log_IC50'].median()]
# prism_public_trunc_eff_IC50 = prism_public_trunc[prism_public_trunc['log_IC50'] < prism_public_trunc['log_IC50'].median()]
# mts021_trunc_eff_IC50 = mts021_trunc[mts021_trunc['log_IC50'] < mts021_trunc['log_IC50'].median()]
# mts022_trunc_eff_IC50 = mts022_trunc[mts022_trunc['log_IC50'] < mts022_trunc['log_IC50'].median()]
# mts023_trunc_eff_IC50 = mts023_trunc[mts023_trunc['log_IC50'] < mts023_trunc['log_IC50'].median()]
# mts024_trunc_eff_IC50 = mts024_trunc[mts024_trunc['log_IC50'] < mts024_trunc['log_IC50'].median()]
# mts025_trunc_eff_IC50 = mts025_trunc[mts025_trunc['log_IC50'] < mts025_trunc['log_IC50'].median()]
# mts026_trunc_eff_IC50 = mts026_trunc[mts026_trunc['log_IC50'] < mts026_trunc['log_IC50'].median()]

# By EC50
# prism_public_full_eff_EC50 = prism_public_full[prism_public_full['log_EC50'] < prism_public_full['log_EC50'].median()]
# mts021_full_eff_EC50 = mts021_full[mts021_full['log_EC50'] < mts021_full['log_EC50'].median()]
# mts022_full_eff_EC50 = mts022_full[mts022_full['log_EC50'] < mts022_full['log_EC50'].median()]
# mts023_full_eff_EC50 = mts023_full[mts023_full['log_EC50'] < mts023_full['log_EC50'].median()]
# mts024_full_eff_EC50 = mts024_full[mts024_full['log_EC50'] < mts024_full['log_EC50'].median()]
# mts025_full_eff_EC50 = mts025_full[mts025_full['log_EC50'] < mts025_full['log_EC50'].median()]
# mts026_full_eff_EC50 = mts026_full[mts026_full['log_EC50'] < mts026_full['log_EC50'].median()]
# prism_public_trunc_eff_EC50 = prism_public_trunc[prism_public_trunc['log_EC50'] < prism_public_trunc['log_EC50'].median()]
# mts021_trunc_eff_EC50 = mts021_trunc[mts021_trunc['log_EC50'] < mts021_trunc['log_EC50'].median()]
# mts022_trunc_eff_EC50 = mts022_trunc[mts022_trunc['log_EC50'] < mts022_trunc['log_EC50'].median()]
# mts023_trunc_eff_EC50 = mts023_trunc[mts023_trunc['log_EC50'] < mts023_trunc['log_EC50'].median()]
# mts024_trunc_eff_EC50 = mts024_trunc[mts024_trunc['log_EC50'] < mts024_trunc['log_EC50'].median()]
# mts025_trunc_eff_EC50 = mts025_trunc[mts025_trunc['log_EC50'] < mts025_trunc['log_EC50'].median()]
# mts026_trunc_eff_EC50 = mts026_trunc[mts026_trunc['log_EC50'] < mts026_trunc['log_EC50'].median()]
...
# prism_mts021_full_eff_AUCsig = pd.merge(prism_public_full_eff_AUCsig, mts021_full_eff_AUCsig, on = ['drug', 'cell line'], suffixes=('_prism', '_mts021'))
# prism_mts021_full_eff_AUCtrapz = pd.merge(gdsc2_full_eff_AUCtrapz, prism_full_eff_AUCtrapz, on = ['Drug ID', 'Cell Line'], suffixes=('_gdsc2', '_prism'))
# prism_mts021_full_eff_AUCsignorm = pd.merge(gdsc2_full_eff_AUCsignorm, prism_full_eff_AUCsignorm, on = ['Drug ID', 'Cell Line'], suffixes=('_gdsc2', '_prism'))
# prism_mts021_full_eff_IC50 = pd.merge(gdsc2_full_eff_IC50, prism_full_eff_IC50, on = ['Drug ID', 'Cell Line'], suffixes=('_gdsc2', '_prism'))
# prism_mts021_full_eff_EC50 = pd.merge(gdsc2_full_eff_EC50, prism_full_eff_EC50, on = ['Drug ID', 'Cell Line'], suffixes=('_gdsc2', '_prism'))
# prism_mts021_trunc_eff_AUCsig = pd.merge(gdsc2_trunc_eff_AUCsig, prism_trunc_eff_AUCsig, on = ['Drug ID', 'Cell Line'], suffixes=('_gdsc2', '_prism'))
# prism_mts021_trunc_eff_AUCtrapz = pd.merge(gdsc2_trunc_eff_AUCtrapz, prism_trunc_eff_AUCtrapz, on = ['Drug ID', 'Cell Line'], suffixes=('_gdsc2', '_prism'))
# prism_mts021_trunc_eff_AUCsignorm = pd.merge(gdsc2_trunc_eff_AUCsignorm, prism_trunc_eff_AUCsignorm, on = ['Drug ID', 'Cell Line'], suffixes=('_gdsc2', '_prism'))
# prism_mts021_trunc_eff_IC50 = pd.merge(gdsc2_trunc_eff_IC50, prism_trunc_eff_IC50, on = ['Drug ID', 'Cell Line'], suffixes=('_gdsc2', '_prism'))
# prism_mts021_trunc_eff_EC50 = pd.merge(gdsc2_trunc_eff_EC50, prism_trunc_eff_EC50, on = ['Drug ID', 'Cell Line'], suffixes=('_gdsc2', '_prism'))
